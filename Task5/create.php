...
<div class="container">
    ...
    <form method="POST">
        <input type="text" name="title" placeholder="Enter Title" value="<?= isset($title)?htmlspecialchars($title):'' ?>" required>
        <textarea name="content" rows="6" placeholder="Enter Content" required><?= isset($content)?htmlspecialchars($content):'' ?></textarea>
